...
function Slideshow() {
  ...
  const images = Array.from({ length: 10 }, (_, index) => `https://nicolecreative.github.io/website/slideshow/${index + 1}.png`);
      ...
      <div className="slideshow">
        ...
        <div className="arrow-container">
          <div className='circle' onClick={handlePrev}>
            <img
              src="https://nicolecreative.github.io/website/slideshowArrow.png"
              alt="Previous"
          ...
          <div className='circle' onClick={handleNext}>
            <img
              src="https://nicolecreative.github.io/website/slideshow1.png"
              alt="Next"
